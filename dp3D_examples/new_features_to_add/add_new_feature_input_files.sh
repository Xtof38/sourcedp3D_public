...
#list='/home/chris/sourcedp3D/dp3D_examples/crushing/input_dp3D'
#list='/home0/chris/compact01/test_bond_plast/test_tensile_20kpart/kin_energy_m7/5pct_intermetallics/input_dp3D'
#list='/home/chris/sourcedp3D/dp3D_examples/generate_gaz_clusters/input_gas /home/chris/sourcedp3D/dp3D_examples/generate_gaz_particles/input_gas '
...
#exit
  ;;
  replace_line )
  echo "new features: in progress"
old_char="# particle bonded_aggregate adhesive_aggregate"
new_char="# particle bonded_aggregate adhesive_aggregate initial_file="
  for fich in $list ; do
